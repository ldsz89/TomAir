...
if (isset($_SESSION['Emp_Type'])){
  ...
  if (isset($_POST['update'])){
    ...
    $update = "UPDATE Employee SET Emp_fname = ?, Emp_fname = ?, Emp_Password = ?, Emp_Type = ? WHERE Emp_ID = ?";
    ...
    while($row = mysqli_fetch_row($result)) {
      ...
      foreach ($row as $value) {
        switch ($counter) {
            ...
            break;
            case 3: echo "<td class='result'><input type='text' name='Emp_fname' value=" . $value . "><br></td>";
            break;
            case 4: echo "<td class='result'><input type='text' name='Emp_Lname' value=" . $value . "><br></td>";
            break;
        }
