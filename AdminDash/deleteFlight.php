...
$database = 'CS3380GRP23';
    ...
    $sql = "DELETE FROM Flights WHERE Fli_Num='" . $_POST['delete'] . "'";

    $result = mysqli_query($link, $sql) or die("Query Error: " . mysqli_error($link));
    echo "<h1>Flight has been deleted <br>";
    echo '<a class="btn btn-lg btn-primary btn-block" href="FlightUp.php">Return to Flight Viewer</a>';
?>

<html>
  <head>
    <title>Toms Air - Flight Upgrade System</title>
