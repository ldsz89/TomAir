...
$database = 'CS3380GRP23';
    ...
    $sql = "DELETE FROM `Log` WHERE Log_Num='" . $_POST['delete'] . "'";

    $result = mysqli_query($link, $sql) or die("Query Error: " . mysqli_error($link));
    echo "<h1>Log has been deleted <br>";
    echo '<a class="btn btn-lg btn-primary btn-block" href="LogView.php">Return to Log Viewer</a>';
?>

<html>
  <head>
    <title>Toms Air - Log Viewer</title>
