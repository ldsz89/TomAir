            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="http://cs3380.rnet.missouri.edu/group/CS3380GRP23/www/PilotDash/FlightViewer.php">Flight Viewer</a></li>
                    </ul>
        ...
        <div class="container">
            <div class="jumbotron text-center">
                ...
                <?php
                    ...
                    $query = "SELECT Flights.Fli_Num AS 'Flight Num', Fli_Dep_Time AS 'Departure Time', Fli_Dep_Date AS 'Departure Date', Fli_Availibility AS 'Availibility', Fli_Dep_City AS 'Departure City', Fli_Arr_City AS 'Arrival City' FROM Flights, Flight_Assign WHERE Flight_Assign.Fli_Num = Flights.Fli_Num AND Emp_ID = ". $_SESSION['Emp_ID'];
